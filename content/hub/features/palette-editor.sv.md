...
Palettpigment fungerar som grunden. De definierar färgerna resten av systemet växer från och påverkar de genererade blandningarna som finns tillgängliga på andra ställen i Lumis färgverktyg.
...
Lumi organiserar palettfärger med värde i åtanke eftersom målare ofta tänker i ljust och mörkt innan de tänker i nyans. Att gruppera blandningar efter tonroll gör det lättare att hitta en färg som hör hemma i den högra delen av bilden, inte bara en som har rätt namn.

Paletter kan också bära sin egen känsla av tonavstånd. En högtydlig illustration, ett lågmält porträtt och ett dämpat landskap kan alla dra nytta av olika värdebetoningar, och paletten kan spegla den strukturen.

## Gradienter och övergångar
...
Palettredigeraren är platsen för att bygga och förfina färgsystemet, medan ljusare palettvyer stödjer snabb åtkomst under målning. Detta håller djup palettdesign tillgänglig utan att tvinga den in i förgrunden varje gång en färg väljs.

Sammantaget hjälper Palette Editor att göra färgval till en sammanhängande praxis: välj pigmenten, utforska deras blandningar, bevara de användbara resultaten och låt paletten bli en del av konstverkets röst.