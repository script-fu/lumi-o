...
- **Файл** → **Сохранить приращение** (Ctrl+I): создать контрольную точку инкрементного восстановления для текущего файла `.lum`.
- **Файл** → **Сохранить как** (Shift+Ctrl+S): сохранить в новый файл `.lum`. Диалоговое окно «Сохранить как» включает параметры сжатия для нового файла проекта.
...
## Восстановление проектаLumi поддерживает автоматическое сохранение в фоновом режиме и дополнительные контрольные точки вручную, доступные из **Файл** → **Восстановить изображение**. Подробную информацию см. на странице [Восстановление файлов](../recovery).
