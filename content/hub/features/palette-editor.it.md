...
type: docs
---
L'editor della tavolozza è il luogo in cui una tavolozza Lumi diventa un ambiente cromatico completo. Riunisce i pigmenti da cui è costruita una tavolozza, le miscele che un artista sceglie di mantenere, i colori utilizzati durante la pittura e la struttura tonale che modella il modo in cui viene esplorata la tavolozza.
...
Lumi organizza la tavolozza dei colori tenendo presente il valore perché i pittori spesso pensano alla luce e al buio prima di pensare alle tonalità. Raggruppare le miscele per ruolo tonale rende più semplice trovare un colore che appartenga alla parte giusta dell'immagine, non solo uno con il nome giusto.

Le tavolozze possono anche portare il proprio senso di spaziatura tonale. Un'illustrazione dai toni alti, un ritratto dai toni bassi e un paesaggio tenue possono tutti trarre vantaggio da un'enfasi di valore diversa e la tavolozza può riflettere quella struttura.

## Gradienti e transizioni
...
L'editor delle tavolozze è il luogo in cui costruire e perfezionare il sistema di colori, mentre le visualizzazioni delle tavolozze più leggere supportano un accesso rapido durante la pittura. Ciò mantiene disponibile il design della tavolozza profonda senza forzarla in primo piano ogni volta che viene scelto un colore.

Nel complesso, l'editor della tavolozza aiuta a trasformare la selezione del colore in una pratica coerente: scegli i pigmenti, esplora le loro miscele, preserva i risultati utili e lascia che la tavolozza diventi parte della voce dell'opera d'arte.