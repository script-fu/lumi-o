...
## Guide alla composizione

Guide laterali opzionali segnano l'area rifilata della pagina con sottili tacche di composizione. Le guide possono seguire divisioni per pagina o una lettura dell'intero doppio foglio, e possono usare terzi, sezioni auree o quinti a seconda di come va giudicato il layout.

Le guide sono pensate come riferimento discreto durante impaginazione e rifinitura. Aiutano a valutare il posizionamento rispetto alla pagina che verrà effettivamente stampata, non solo rispetto all'intera tela digitale.

## Visualizzare il layout sulla tela

Le sovrapposizioni di layout sono controllate dal menu Visualizza. Le aree di abbondanza, rilegatura e guida possono essere mostrate singolarmente o insieme, così l'artista può concentrarsi sulla parte della struttura editoriale che conta in quel momento.

Immagine > Abilita layout attiva o disattiva i limiti di layout per l'immagine corrente. Quando il layout è disabilitato, le sovrapposizioni vengono nascoste e le opzioni di visualizzazione si ritirano, ma le impostazioni dei limiti restano salvate nel file per un uso successivo.

## Salvato con il progetto

Le impostazioni di layout viaggiano con il progetto `.lum`. Riaprendo l'immagine in seguito si ripristinano abbondanza, margine di rilegatura, aspetto delle sovrapposizioni, scelte delle guide e stato di abilitazione del layout per quel file. La configurazione legata alla pubblicazione resta parte dello stato operativo dell'opera, non una preferenza di visualizzazione temporanea.

Per gli artisti che passano dallo schizzo alla pittura e alla preparazione per la stampa, il flusso di lavoro resta in un unico posto: la stessa immagine a livelli, con la struttura editoriale disponibile ogni volta che la pagina la richiede.
