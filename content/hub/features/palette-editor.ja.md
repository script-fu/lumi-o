...
## 値のバンド値バンドは、5 つの明度ゾーン間の境界がどこに位置するかを定義します。 By default they divide lightness evenly across the 0–100% range, but you can adjust them to match the tonal structure of your subject.ペインタが値のバンドとそれらの間のギャップを定義および管理するのに便利です。
