...
type: docs
---
L'éditeur de palette est l'endroit où une palette Lumi devient un environnement de couleurs complet. Il rassemble les pigments à partir desquels une palette est construite, les mélanges qu'un artiste choisit de conserver, les couleurs utilisées lors de la peinture et la structure tonale qui façonne la façon dont la palette est explorée.
...
Les pigments de la palette servent de fond de teint. Ils définissent les couleurs à partir desquelles le reste du système se développe et influencent les mélanges générés disponibles ailleurs dans les outils de couleur de Lumi.
...
Lumi organise les couleurs de la palette en gardant à l'esprit la valeur, car les peintres pensent souvent en lumière et en obscurité avant de penser en teinte. Le regroupement des mélanges par rôle tonal permet de trouver plus facilement une couleur qui appartient à la bonne partie de l'image, et pas seulement celle qui porte le bon nom.

Les palettes peuvent également avoir leur propre espacement tonal. Une illustration claire, un portrait discret et un paysage discret peuvent tous bénéficier d'une valeur différente, et la palette peut refléter cette structure.
...
L'éditeur de palette permet de créer et d'affiner le système de couleurs, tandis que les vues de palette plus claires permettent un accès rapide pendant la peinture. Cela permet de conserver un design de palette profond sans le forcer au premier plan à chaque fois qu'une couleur est choisie.

Dans l'ensemble, l'éditeur de palette contribue à transformer la sélection des couleurs en une pratique cohérente : choisissez les pigments, explorez leurs mélanges, préservez les résultats utiles et laissez la palette faire partie de la voix de l'œuvre d'art.