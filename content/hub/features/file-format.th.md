...
- **ไฟล์** → **บันทึกส่วนเพิ่ม** (Ctrl+I): สร้างจุดตรวจสอบการกู้คืนส่วนเพิ่มสำหรับไฟล์ `.lum` ปัจจุบัน
- **ไฟล์** → **บันทึกเป็น** (Shift+Ctrl+S): บันทึกเป็นไฟล์ `.lum` ใหม่ กล่องโต้ตอบบันทึกเป็นมีตัวเลือกการบีบอัดสำหรับไฟล์โปรเจ็กต์ใหม่
...
## การกู้คืนโครงการLumi รักษาการบันทึกพื้นหลังอัตโนมัติและจุดตรวจสอบที่เพิ่มขึ้นด้วยตนเอง ซึ่งทั้งคู่สามารถเข้าถึงได้จาก **ไฟล์** → **กู้คืนรูปภาพ** ดูหน้า [การกู้คืนไฟล์](../recovery) สำหรับรายละเอียดทั้งหมด
