...
Il sistema di recupero di Lumi-o è progettato per proteggere il lavoro di pittura da arresti anomali, errori e sessioni interrotte. Offre ai progetti una rete di sicurezza senza costringere gli artisti a duplicare costantemente i file a mano.
...
Mentre un'immagine viene modificata, Lumi-o può mantenere i dati di recupero separati dal file di lavoro principale. Il progetto non deve quindi essere riscritto ogni volta che viene creata un'istantanea di sicurezza.
...
Lumi-o supporta checkpoint a livello di progetto per questi momenti. Sono più leggeri che conservare una copia completa separata per ogni esperimento, ma offrono comunque all'artista un modo per tornare a punti significativi nella storia dell'opera.
...
Un sistema di recupero utile deve anche restare gestibile. Lumi-o è progettato per mantenere organizzati i dati di recupero e rendere rimovibili gli stati vecchi quando non servono più.
...
Lo scopo del recupero file non è sostituire il salvataggio, ma rendere il lavoro creativo meno fragile. Gli artisti possono dipingere, sperimentare e correre rischi sapendo che Lumi-o mantiene ulteriori vie di ritorno quando una sessione, un file o una decisione va storta.
