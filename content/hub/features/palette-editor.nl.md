...
type: docs
---
In de Palette Editor wordt een Lumi-palet een complete kleuromgeving. Het brengt de pigmenten samen waaruit een palet is opgebouwd, de mengsels die een kunstenaar wil behouden, de kleuren die tijdens het schilderen worden gebruikt en de toonstructuur die bepaalt hoe het palet wordt verkend.
...
Paletpigmenten fungeren als basis. Ze definiëren de kleuren waaruit de rest van het systeem groeit en beïnvloeden de gegenereerde mixen die elders in de kleurtools van Lumi beschikbaar zijn.
...
Lumi organiseert paletkleuren met waarde in het achterhoofd, omdat schilders vaak in licht en donker denken voordat ze in tint denken. Door mengsels te groeperen op toonrol, wordt het gemakkelijker om een ​​kleur te vinden die in het juiste deel van de afbeelding thuishoort, en niet alleen een kleur die de juiste naam heeft.

Paletten kunnen ook hun eigen gevoel voor toonafstand hebben. Een opvallende illustratie, een rustig portret en een gedempt landschap kunnen allemaal profiteren van verschillende waardeaccenten, en het palet kan die structuur weerspiegelen.
...
De Palette Editor is de plek voor het opbouwen en verfijnen van het kleursysteem, terwijl lichtere paletweergaven snelle toegang tijdens het schilderen ondersteunen. Hierdoor blijft een diep paletontwerp beschikbaar zonder dat het elke keer dat een kleur wordt gekozen naar de voorgrond wordt geforceerd.

Over het geheel genomen helpt de Palette Editor kleurselectie om te zetten in een samenhangende praktijk: kies de pigmenten, verken hun mengsels, behoud de bruikbare resultaten en laat het palet onderdeel worden van de stem van het kunstwerk.