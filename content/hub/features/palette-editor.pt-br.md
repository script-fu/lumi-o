...
type: docs
---
O Palette Editor é onde uma paleta Lumi se torna um ambiente de cores completo. Reúne os pigmentos a partir dos quais uma paleta é construída, as misturas que o artista escolhe manter, as cores usadas durante a pintura e a estrutura tonal que molda a forma como a paleta é explorada.
...
Os pigmentos da paleta atuam como base. Eles definem as cores a partir das quais o resto do sistema cresce e influenciam as misturas geradas disponíveis em outras partes das ferramentas de cores do Lumi.
...
Lumi organiza as cores da paleta com o valor em mente porque os pintores muitas vezes pensam no claro e no escuro antes de pensarem nos matizes. Agrupar mixagens por função tonal torna mais fácil encontrar uma cor que pertença à parte certa da imagem, e não apenas uma que tenha o nome correto.

As paletas também podem ter seu próprio senso de espaçamento tonal. Uma ilustração destacada, um retrato discreto e uma paisagem silenciosa podem se beneficiar de diferentes ênfases de valores, e a paleta pode refletir essa estrutura.
...
O Palette Editor é o local para construir e refinar o sistema de cores, enquanto as visualizações de paleta mais claras oferecem acesso rápido durante a pintura. Isso mantém o design profundo da paleta disponível sem forçá-lo a ficar em primeiro plano sempre que uma cor é escolhida.

No geral, o Palette Editor ajuda a transformar a seleção de cores em uma prática coerente: escolha os pigmentos, explore suas misturas, preserve os resultados úteis e deixe a paleta se tornar parte da voz da obra de arte.