...
{{< cards >}}
  {{< card link="brush-caching" title="刷机缓存" icon="lightning-bolt" subtitle="通过重复使用在真实绘画中重要的画笔状态，保持最喜欢的画笔的响应能力。" >}}
  ...
  {{< card link="warp-tool" title="扭曲工具" icon="cursor-click" subtitle="直接重塑绘制的内容，同时保留复杂艺术品的分层结构。" >}}
