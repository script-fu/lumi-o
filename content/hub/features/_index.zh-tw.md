...
{{< cards >}}
  ...
  {{< card link="filters" title="濾鏡" icon="filter" subtitle="透過模糊、光照、紋理、印刷與分析類濾鏡，校正、風格化、產生效果，並保持圖層效果可編輯。" >}}
  {{< card link="recovery" title="檔案復原" icon="refresh" subtitle="背景保護與主動檢查點，讓繪畫過程不再脆弱。" >}}
  {{< card link="layers" title="圖層與非破壞性編輯" icon="collection" subtitle="結構化繪畫：可編輯圖層、群組、遮罩、效果與受保護的工作狀態。" >}}
  {{< card link="paintbrush" title="畫筆工具" icon="pencil-alt" subtitle="富有表現力的繪畫：反應靈敏的筆觸、動態輸入、紋理、平滑與多頭畫筆行為。" >}}
  {{< card link="palette-editor" title="調色盤編輯器" icon="color-swatch" subtitle="以顏料、已儲存混色、已用顏色、明度與漸層，建構完整的色彩系統。" >}}
  ...
  {{< card link="workspaces" title="工作區" icon="view-boards" subtitle="在素描、繪畫、勾線、上色與專注等預設工作室環境之間切換。" >}}
{{< /cards >}}
