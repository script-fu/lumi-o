...
- **角度** (0 ～ 360°): フォーメーション リングの静的な向き。**フォロー方向** が 1.0 未満の場合に使用されます。
...
- **散乱角度** (0 ～ 90°、デフォルト 10°): この値までの新たにランダム化された角度で、各ヘッドをストローク方向から外側に扇状に広げます。 90°に固定されているため、ヘッドが後ろを向くことはありません。
- **前方散乱** (0 ～ 4000 ピクセル): ストローク方向の前方にある最大のランダムな散乱。描点ごとに独立して再ロールされます。
- **後方散乱** (0 ～ 4000 ピクセル): ストロークの後方の最大ランダム散乱。頭はまだ前を向いています。変位方向のみが反転します。 Forward と Backward の両方を同時にゼロ以外にすることができます。
- **スキャッター サイズ バランス** (0.0–1.0): 大きなヘッドの最小スキャッター ウェイト。 0 では、大きなヘッドがストロークの近くに着地します。 1 では、サイズに関係なくすべての頭が均等に分散されます。
- **散乱サイズのしきい値** (1 ～ 100 ピクセル): このピクセル半径より小さい頭部は全距離で散乱します。大きなヘッドは徐々にストロークに近づきます。
...
### 追加オプション**追加オプション** エキスパンダー (デフォルトでは折りたたまれています):
