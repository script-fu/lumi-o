...
La deformazione sembra applicare movimento all'immagine. Invece di selezionare una casella di trasformazione rigida, l'artista può lavorare in modo locale, costruendo lo spostamento con tratti finché la forma non risulta corretta.

Lo strumento è utile sia per correzioni sottili sia per distorsioni marcate. Una guancia può essere ammorbidita, una manica può essere tirata nel ritmo giusto, il fogliame può acquistare fluidità o uno schizzo può essere spinto verso il gesto desiderato.

## Deformazione consapevole dei gruppi
...
La deformazione è naturalmente esplorativa. Gli artisti spesso devono provare un tratto, confrontare il risultato, ammorbidirlo, annullarlo o costruire gradualmente una modifica più forte.

Lo strumento Deformazione supporta questo tipo di iterazione lasciando la deformazione operativa regolabile durante la sessione. L'artista può perfezionare lo spostamento prima di inserire la modifica nella normale cronologia di annullamento dell'immagine.

## Usi creativi

Oltre alla correzione, la deformazione può essere uno strumento di segno e progettazione. Può aggiungere movimento a capelli e tessuti, esagerare l'espressione, piegare forme grafiche, increspare texture o creare distorsioni pittoriche difficili da disegnare manualmente.

Poiché funziona con soggetti a livelli, lo strumento è adatto sia alla modellazione iniziale sia alla rifinitura in fase avanzata, aiutando gli artisti a rimodellare un'immagine mantenendo flessibile il processo di pittura.
