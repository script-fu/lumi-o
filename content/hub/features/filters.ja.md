...
チェッカーボードは、規則的な交互のタイル パターンを生成します。シンプルですが、そのシンプルさにより、透明度のテスト、マスクの作成、グラフィック背景のブロック、またはきれいな幾何学的ソース マテリアルの作成に役立ちます。
...
### ウェーブWave は、波形プロファイル、幾何学的配置、歪み、フラクタル詳細、位相オフセットによって形成された帯状または環状のパターンを生成します。これは単なるストライプ ツール以上のものであり、制御された波紋、地形的なバンド、モアレのようなグラフィック、またはノイズの多い同心円パターン フィールドを生成できます。
