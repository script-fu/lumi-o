...
## Strumenti personalizzati, non impostazioni sparse

Una preimpostazione strumento è più di una regolazione salvata. È uno strumento completo definito dall'artista: identità, sensazione operativa, scelte di configurazione e, quando serve, pennello privato, dinamiche, sfumatura o icona.

Una preimpostazione può comportarsi come un oggetto reale nel kit dell'artista. Una matita da schizzo preferita resta una matita da schizzo. Un pennello da blocchi mantiene il suo carattere ampio e semplice. Un pennello di rifinitura resta preciso e familiare. Lo strumento non viene ricostruito a memoria ogni volta: viene selezionato come strumento noto.
...
Le preimpostazioni salvate possono essere presentate come pulsanti strumento, completi di icone personalizzate. Una collezione di preimpostazioni diventa uno scaffale riconoscibile di strumenti personalizzati, non un elenco di configurazioni anonime.

L'identità visiva conta. Gli artisti possono scegliere gli strumenti per forma, colore, icona e abitudine, costruendo la stessa memoria muscolare che sviluppano con i materiali fisici. Una piccola fila di preimpostazioni affidabili può risultare più rapida e più personale della ricerca ripetuta tra le impostazioni.

## Kit di strumenti legati agli spazi di lavoro
...
## Portabilità delle preimpostazioni

Una preimpostazione possiede le risorse che la rendono unica. Per un preset pennello, pennello, dinamiche e icona risiedono nella preimpostazione stessa, così lo strumento resta completo anche quando cambia la libreria di risorse più ampia.

È una semplificazione deliberata: uno strumento salvato non è un fragile puntatore a più parti mobili separate. I pennelli possono ancora essere salvati in una libreria riutilizzabile, ma quando vengono scelti per una preimpostazione vengono copiati nello strumento personalizzato.

Per gli artisti la parte importante è che uno strumento possa essere salvato come decisione creativa completa. Comportamento, identità e risorse viaggiano insieme, rendendo le preimpostazioni strumento una base pratica per flussi di lavoro personali, kit specifici per progetto e configurazioni di studio condivise.

## Un set familiare di strumenti
