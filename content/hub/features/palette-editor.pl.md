...
type: docs
---
Edytor palet to miejsce, w którym paleta Lumi staje się kompletnym środowiskiem kolorów. Łączy pigmenty, z których zbudowana jest paleta, mieszanki, które artysta wybiera, kolory używane podczas malowania oraz strukturę tonalną, która kształtuje sposób eksploracji palety.
...
Pigmenty paletowe pełnią rolę podkładu. Definiują kolory, z których wywodzi się reszta systemu i wpływają na generowane miksy dostępne w innych narzędziach kolorów Lumi.
...
Lumi porządkuje paletę kolorów, mając na uwadze wartość, ponieważ malarze często myślą w świetle i ciemności, zanim pomyślą o odcieniu. Grupowanie miksów według roli tonalnej ułatwia znalezienie koloru, który pasuje do właściwej części obrazu, a nie tylko tego, który ma odpowiednią nazwę.

Palety mogą również zawierać własne poczucie odstępów tonalnych. Wyraźna ilustracja, stonowany portret i stonowany krajobraz mogą zyskać dzięki różnym naciskom na wartości, a paleta może odzwierciedlać tę strukturę.
...
Edytor palet to miejsce, w którym można budować i udoskonalać system kolorów, a jaśniejsze widoki palet umożliwiają szybki dostęp podczas malowania. Dzięki temu głęboka paleta jest dostępna bez wysuwania jej na pierwszy plan za każdym razem, gdy wybierany jest kolor.

Ogólnie rzecz biorąc, Edytor palet pomaga przekształcić wybór kolorów w spójną praktykę: wybieraj pigmenty, eksploruj ich mieszaniny, utrwalaj przydatne rezultaty i pozwól, aby paleta stała się częścią głosu dzieła sztuki.