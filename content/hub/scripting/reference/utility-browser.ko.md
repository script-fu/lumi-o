...
유틸리티 라이브러리는 래핑 패턴을 실제로 적용한 것입니다. 각 도우미는 하위 수준 작업에 명확한 이름을 제공하고, 상용구를 숨기고, 기본 명령이 변경될 경우 업데이트할 단일 위치를 제공합니다. 그 뒤에 숨은 디자인 접근 방식을 이해하려면 **[Wrapping]({{< ref "/hub/scripting/tutorials/Wrapping/wrapping" >}})** 튜토리얼을 참조하세요.
