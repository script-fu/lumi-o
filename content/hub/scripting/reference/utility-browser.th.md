...
ไลบรารียูทิลิตี้เป็นการประยุกต์ใช้รูปแบบการตัดคำในทางปฏิบัติ: ตัวช่วยแต่ละคนจะตั้งชื่อที่ชัดเจนให้กับการดำเนินการระดับต่ำ ซ่อนต้นแบบ และจัดให้มีที่เดียวสำหรับการอัปเดตหากคำสั่งที่ซ่อนอยู่มีการเปลี่ยนแปลง หากคุณต้องการเข้าใจแนวทางการออกแบบที่อยู่เบื้องหลัง โปรดดูบทแนะนำ **[Wrapping]({{< ref "/hub/scripting/tutorials/Wrapping/wrapping" >}})**
