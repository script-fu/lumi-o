...
{{< cards >}}
  ...
  {{< card link="procedure-browser" title="Przeglądarka procedur" icon="book-open" subtitle="Przeglądaj procedury w bazie danych procedur Lumi (PDB)" >}}
  {{< card link="plugin-browser" title="Przeglądarka wtyczek" icon="chip" subtitle="Przeglądaj system menu wtyczek i zainstalowane rozszerzenia" >}}
{{< /cards >}}
