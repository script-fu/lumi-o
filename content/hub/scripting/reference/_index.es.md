...
{{< cards >}}
  ...
  {{< card link="procedure-browser" title="Navegador de procedimientos" icon="book-open" subtitle="Explore los procedimientos en la base de datos de procedimientos Lumi (PDB)" >}}
  {{< card link="plugin-browser" title="Navegador de complementos" icon="chip" subtitle="Explore el sistema de menú de complementos y las extensiones instaladas" >}}
{{< /cards >}}