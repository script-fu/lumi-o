...
{{< cards >}}
  ...
  {{< card link="procedure-browser" title="Browser delle procedure" icon="book-open" subtitle="Esplora le procedure nel database procedurale Lumi (PDB)" >}}
  {{< card link="plugin-browser" title="Browser plug-in" icon="chip" subtitle="Sfoglia il sistema di menu dei plug-in e le estensioni installate" >}}
{{< /cards >}}