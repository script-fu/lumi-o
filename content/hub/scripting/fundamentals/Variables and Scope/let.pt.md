...
Existem três formas principais de `let` no Scheme:
...
Na sua forma mais simples, `let` cria ligações de variáveis locais e avalia uma expressão com essas ligações.
