...
### O papel das definições de variáveis e do escopo em Scheme
...
Scheme fornece várias construções para definir e definir o escopo de variáveis:
...
- **Definições e escopo de variáveis** são fundamentais para organizar e gerenciar dados em seus scripts de Scheme.
