...
Pode usar `define` para criar procedimentos reutilizáveis.
...
Quando usado dentro de uma função, `define` cria ligações locais que são acessíveis apenas dentro da função envolvente. Isso evita poluir o namespace global e ajuda a organizar o código.
...
3. **Legibilidade aprimorada**:
 - Dividir a lógica em funções menores e bem nomeadas melhora a clareza e a capacidade de manutenção do código.
