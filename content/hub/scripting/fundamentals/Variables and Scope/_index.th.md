...
```scheme
(define x 42)       ; x เป็นตัวเลข
(set! x "hello")    ; ตอนนี้ x เป็นสตริง
```
...
- **คำจำกัดความและขอบเขตของตัวแปร** เป็นพื้นฐานสำหรับการจัดระเบียบและจัดการข้อมูลในสคริปต์ Scheme ของคุณ
