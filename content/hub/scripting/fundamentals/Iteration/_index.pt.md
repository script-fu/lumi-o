...
### O papel da iteração no Scheme

A iteração cumpre vários propósitos essenciais nos scripts:
...
3. **Devolver um resultado (opcional):** Dependendo da construção, a iteração pode produzir um resultado ou modificar o estado.
