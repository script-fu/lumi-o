...
---
La funzione `map` in Scheme applica una procedura a ogni elemento di una lista (o più liste) e **restituisce una nuova lista** con i risultati. È ideale per trasformare i dati.
