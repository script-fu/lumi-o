...
---
Функция `map` в Scheme применяет процедуру к каждому элементу списка (или нескольких списков) и **возвращает новый список** с результатами. Идеальна для преобразования данных.
