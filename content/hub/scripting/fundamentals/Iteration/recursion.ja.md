...
weight: 5
---
Recursion is a powerful concept in Scheme, where a function calls itself to solve smaller sub-problems of the original problem. **単純な再帰** パターンには、再帰を停止する基本ケースと問題を軽減する再帰ケースが含まれます。
