...
- Quando um teste é avaliado como verdadeiro (`#t`), o respetivo **consequente** correspondente é executado e a expressão `cond` para de avaliar testes adicionais.
...
2. **Executar a correspondência consequente**:
 - Quando o primeiro teste avaliado como verdadeiro (`#t`) é encontrado, o respetivo **consequente** é executado.
