...
**Использование**:
```scheme
(greet "Hello" "Alice" "Bob" "Charlie")  ; Возвращает ("Hello Alice" "Hello Bob" "Hello Charlie")
```
...
; Возвращает "Fruits: Apple, Banana, Cherry"
```
...
**Использование**:
```scheme
(sum-positive -5 3 7 -2 8)  ; Возвращает 18
```
...
**Использование**:
```scheme
(max-value 10 20 5 40 15)  ; Возвращает 40
```
