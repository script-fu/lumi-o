...
1. **Войдите в GitHub**: перейдите на [GitHub](https://github.com/) и войдите в свою учетную запись.
...
- **Удаленный**. Удаленный репозиторий — это версия вашего проекта, размещенная на такой платформе, как GitHub. Локальная версия вашего проекта на вашем компьютере связана с этим удалённым репозиторием, так что вы можете загружать (извлекать) и загружать (извлекать) изменения.
