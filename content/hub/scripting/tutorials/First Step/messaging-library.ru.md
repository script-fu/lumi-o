...
Библиотека сообщений в настоящее время включает в себя следующие функции:- **send-to-gui**: отправляет сообщения в диалоговое окно Lumi GUI.
- **send-to-error-console**: отправляет сообщения в консоль сообщений Lumi.
...
- **отправить на уведомление**: отображать сообщения как системные уведомления. Следуя той же схеме модульного дизайна и многократного использования функций, эта библиотека может превратиться в комплексный инструмент для решения всех видов задач обмена сообщениями.
...
Мы можем настроить структуру файла:```plaintext
