...
weight: 6
---
เมื่อเวลาผ่านไป สิ่งที่เริ่มต้นจากการเป็นฟังก์ชันเดียวในการส่งข้อความได้พัฒนาไปสู่ชุดของฟังก์ชันที่เกี่ยวข้องกัน ขณะนี้ฟังก์ชันเหล่านี้เป็นรากฐานของ **ไลบรารีข้อความ** ซึ่งออกแบบมาเพื่อจัดการเอาต์พุตไปยังปลายทางต่างๆ เช่น GUI, คอนโซลข้อความ และเทอร์มินัล OS
