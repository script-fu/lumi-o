...
---
เมื่อเวลาผ่านไป สิ่งที่เริ่มต้นจากการเป็นฟังก์ชันเดียวในการส่งข้อความได้พัฒนาไปสู่ชุดของฟังก์ชันที่เกี่ยวข้องกัน ฟังก์ชันเหล่านี้เป็นรากฐานของ **ไลบรารีข้อความ** ที่ออกแบบมาเพื่อจัดการเอาต์พุตไปยังปลายทางต่างๆ เช่น GUI คอนโซล Message และเทอร์มินัลของระบบปฏิบัติการ
...
- **send-to-terminal**: ส่งข้อความไปยังหน้าต่างเทอร์มินัล
- **send-message**: ฟังก์ชันโปรแกรมเลือกจ่ายงานที่จะส่งข้อความไปยังเอาต์พุตที่เหมาะสม
...
- **send-to-file**: บันทึกข้อความลงในไฟล์บันทึก
- **send-to-logger**: ผสานรวมกับระบบบันทึกภายนอก
- **send-to-notification**: แสดงข้อความเป็นการแจ้งเตือนของระบบ
...
- **ความสอดคล้อง**: การใช้ฟังก์ชันตรวจสอบและจัดการข้อความชุดเดียวกันช่วยให้พฤติกรรมสม่ำเสมอทั่วทั้งแอปพลิเคชัน
