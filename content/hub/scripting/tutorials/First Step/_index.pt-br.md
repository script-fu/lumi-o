...
- Um editor de texto para arquivos `.scm` (VS Code funciona bem): [Visual Studio Code](/hub/scripting/tools/visual-studio-code)
- [Git](/hub/scripting/tools/git/) para manter o backup do seu código e a versão controlada.
