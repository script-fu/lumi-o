...
## Логика оператора if в Scheme

Прежде чем приступить к примеру с реорганизованной библиотекой, приведем краткий обзор условной логики. Scheme использует `if` для выбора между двумя путями.
