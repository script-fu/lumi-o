...
คุณสามารถเรียกดูชื่อที่ส่งออกทั้งหมด อ่านเอกสาร และดูว่ามาจากไลบรารีใดใน **[Utility Browser]({{< ref "/hub/scripting/reference/utility-browser" >}})** (วิธีใช้ → การเขียนโปรแกรม → เบราว์เซอร์ยูทิลิตี้) นี่เป็นการสาธิตการใช้งานจริงของการห่อตามขนาด และเป็นแหล่งรูปแบบที่มีประโยชน์ในการยืมเมื่อสร้างไลบรารีตัวช่วยของคุณเอง
