...
È possibile sfogliare ogni nome esportato, leggere la relativa docstring e vedere da quale libreria proviene in **[Utility Browser]({{< ref "/hub/scripting/reference/utility-browser" >}})** (Guida → Programmazione → Utility Browser). Si tratta di una dimostrazione pratica del confezionamento su larga scala e di un'utile fonte di modelli da prendere in prestito quando si crea la propria libreria di supporto.
