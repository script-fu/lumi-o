...
|--------------------|---------------------|----------------------|-------------------------|--------------------|
| Debian | APT | GDM | GNOMO | Wayland |
| Ubuntu | APT | GDM | GNOMO | Wayland |
| Debian | APT | GDM | Cannella | X11 |
| Fedora | DNF | GDM | GNOMO | Wayland |
| ArcoLinux | Pacman | Scelta dell'utente | Scelta dell'utente | Scelta dell'utente |
