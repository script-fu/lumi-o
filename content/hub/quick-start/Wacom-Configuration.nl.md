...
- Vorm het gevoel met de borstel zelf, omdat de penseeldynamiek al niet-lineair kan zijn.
...
Bewerken → Voorkeuren → Invoerapparaten → Tablet, stylus en andere apparaten configureren...

Hier kunt u de globale drukcurve voor uw stylus instellen.

## Wacom-aanraakring

Lumi ondersteunt nu rechtstreeks Wacom Touch Ring-invoer, inclusief modifier-gebaseerde ringinvoer.

In hetzelfde apparaatconfiguratiedialoogvenster kunt u belacties per ingang toewijzen, waaronder:

- Penseelgrootte
- Relatieve grootte van het penseel
- Borstelhoek
- Kijkhoek
- Bekijk zoom
