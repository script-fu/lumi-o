...
2. Ouvrez un terminal dans votre répertoire de téléchargement.
...
Si vous souhaitez travailler à partir des sources, accédez à [Technical Guides](/hub/technical-guides/) et [How to Install Linux](/hub/install-linux/).