...
2. Apri un terminale nella directory di download.
3. Rendere eseguibile il file.
4. Eseguilo.
...
Se vuoi lavorare dal codice sorgente, vai su [Technical Guides](/hub/technical-guides/) e [How to Install Linux](/hub/install-linux/).