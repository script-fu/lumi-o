...
2. Open een terminal in uw downloadmap.
...
Als je vanuit de bron wilt werken, ga dan naar [Technical Guides](/hub/technical-guides/) en [How to Install Linux](/hub/install-linux/).