...
2. Öppna en terminal i din nedladdningskatalog.
3. Gör filen körbar.
4. Kör det.
...
Om du vill arbeta från källan, gå till [Technical Guides](/hub/technical-guides/folder/) och [How to Install Linux](/hub/install-linux/).