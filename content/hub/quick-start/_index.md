...
2. Open a terminal in your download directory.
...
If you want to work from source, go to [Technical Guides](/hub/technical-guides/folder/) and [How to Install Linux](/hub/install-linux/).
