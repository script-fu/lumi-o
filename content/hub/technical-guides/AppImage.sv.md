...
Obs: CI bygger AppImage med hjälp av Lumis in-repo integrerade beroendekällor (BABL/GEGL/GTK3), så beroendestacken överensstämmer med det lokala `lumi-build-script.sh` arbetsflödet.
