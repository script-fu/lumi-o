...
환경 설정, 스크립트 아키텍처, 문제 해결을 포함한 Lumi CI 빌드 프로세스에 대한 포괄적인 기술 세부 정보는 [README-CI.md](https://gitlab.gnome.org/pixelmixer/lumi/-/blob/main/build/linux/appimage/README-CI.md)을 참조하세요.