---
title: "适用于 Linux 的开源数字绘画"
toc: false
type: docs
---
[![gui-01](/images/screens/gui-00.jpg)](/images/screens/gui-01.jpg)

Lumi-o 专为分层光栅绘画而设计，刻意精简且稳定。 Wacom 数位板支持经过广泛测试，可提供专业插画所需的流畅、响应灵敏的输入。
...
Lumi-o 是在 Debian 13 上使用 Cinnamon 桌面开发的。如果您来自 Windows，安装 Debian 是第一步：[如何安装 Linux](/hub/install-linux/)。

{{< cards >}}
  {{< card link="hub/about/" title="关于" icon="information-circle" >}}
  {{< card link="hub/quick-start/" title="快速入门" icon="play" >}}
  {{< card link="hub/features/" title="特征" icon="book-open" >}}
{{< /cards >}}